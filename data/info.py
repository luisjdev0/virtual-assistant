...
class gui_controller():
    ...
    def get_add_commands_window(self, x):
        ...
        self.m_window.add_commands_window.CommandName.clear()
        self.m_window.add_commands_window.CommandKeys.clear()
        self.m_window.add_commands_window.CommandContent.clear()
